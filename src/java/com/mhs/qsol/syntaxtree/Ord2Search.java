...
/**
 * Grammar production: f0 -> <OP2> f1 -> CheckOrd3Search() f2 -> ( Ord2Search()
 * )?
 */
public class Ord2Search implements Node {
  public NodeToken f0;
  public CheckOrd3Search f1;
  public NodeOptional f2;

  public Ord2Search(NodeToken n0, CheckOrd3Search n1, NodeOptional n2) {
    f0 = n0;
    f1 = n1;
    f2 = n2;
  }

  public Ord2Search(CheckOrd3Search n0, NodeOptional n1) {
    f0 = new NodeToken("op2");
    f1 = n0;
    f2 = n1;
  }
