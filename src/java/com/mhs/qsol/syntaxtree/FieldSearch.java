...
/**
 * Grammar production: f0 -> <FIELDSTART> f1 -> CheckOrd1Search() f2 -> ")"
 */
public class FieldSearch implements Node {
  public NodeToken f0;
  public CheckOrd1Search f1;
  public NodeToken f2;

  public FieldSearch(NodeToken n0, CheckOrd1Search n1, NodeToken n2) {
    f0 = n0;
    f1 = n1;
    f2 = n2;
  }

  public FieldSearch(CheckOrd1Search n0) {
    f0 = new NodeToken("(");
    f1 = n0;
    f2 = new NodeToken(")");
  }
